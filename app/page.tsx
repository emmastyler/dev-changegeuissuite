...
export default function HomePage() {
  ...
  const [plan, setPlan] = useState<"individual" | "team" | null>(null);
  ...
  const handleStart = () => {
    if (isAuthenticated) {
      ...
      router.push("/signup?returnUrl=/assessment/select");
    }
  };

  const proceed = () => {
    if (plan === "individual") router.push("/payment?plan=individual");
    if (plan === "team") router.push("/teams/create");
  };
      ...
      <div className="page">
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                Understand how you and your team drive transformation, align
                execution, and improve results.
              </p>
              <button
                onClick={handleStart}
                style={{
              ...
              >
                <button
                  ...
                  style={{
                    ...
                    borderRadius: 16,
                    background:
                      plan === "individual" ? "var(--blue-light)" : "white",
                    textAlign: "left",
                  }}
                >
                  ...
                  <span style={{ fontSize: 14 }}>
                    Discover your Change Genius role and ADAPTS profile – $24
                    one-time
                  </span>
                </button>
                <button
                  ...
                  style={{
                    ...
                    border: "2px solid var(--blue)",
                    borderRadius: 16,
                    background: plan === "team" ? "var(--blue-light)" : "white",
                    textAlign: "left",
                  }}
                >
        ...
        >
          ...
          >
            ...
            <button onClick={handleStart} style={btnWhite}>
              Take Assessment — $24
            </button>
            <div
              style={{
          ...
          >
            ...
            <button onClick={handleStart} style={btnBlue}>
